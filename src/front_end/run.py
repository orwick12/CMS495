...
@app.route("/")
def template_test():
    return render_template('template.html', my_string="News Sources:",
        my_list=["https://www.apnews.com/", "https://www.usatoday.com/", "https://www.bbc.com/news","https://www.cnn.com/", "http://www.foxnews.com/"], title="Trusted News Source", current_time=datetime.datetime.now())
